package steve.step_definitions.selenium;
...
public class acre extends AbstractPage {
...
// Pass the url
        driver.get("https://www.acremortgage.com/page/loan-programs");

        WebElement el = driver.findElement(By.xpath(".//input[@id = 'contact_form_first_name']"));
        el.sendKeys("steve");
